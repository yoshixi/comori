...
The Techo is an application for managing focused work sessions. It should provide the task management and time tracking features to help users stay focused on their work.

## UIs

### List of Tasks

The main UI of Techo is the list of tasks. Users can add, edit, and delete tasks from this list. Each task has a title, description, and a status (e.g., "To Do", "In Progress", "Done").
...
Mermaid diagram of the data structure used in Techo:
